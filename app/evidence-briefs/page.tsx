...
export default function EvidenceBriefs() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="border border-rule p-8 bg-paper-dark mb-8">
        <h2 className="font-serif text-xl font-bold mb-4 text-gray">
          Evidence Brief Format
        </h2>
        <ul className="space-y-3 text-sm text-gray">
          <li>
            <span className="font-semibold text-ink">THE QUESTION</span> — One
            sentence framing the policy question.
          </li>
          <li>
            <span className="font-semibold text-ink">WHAT THE DATA SHOWS</span>{" "}
          ...
          <li>
            <span className="font-semibold text-ink">THE BOTTOM LINE</span> —
            Clear statement of what evidence suggests. Uncertainties acknowledged.
          </li>
          <li>
            <span className="font-semibold text-ink">SOURCES</span> — Every
